...
public final class SunshinePreferences {
    ...
    /**
     * Resets the location City name stores in SharedPreferences.
     *
     * @param context Context used to get the SharedPreferences
     */
    public static void resetLocationCityName(Context context) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
        editor.remove(context.getString(R.string.pref_location_key));
        editor.apply();
    }
    ...
    public static void setLocationCityName(Context context, String cityName) {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(context.getString(R.string.pref_location_key), cityName);
        editor.apply();
    }
